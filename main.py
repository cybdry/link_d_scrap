...
def login():
    ...
    email = config['fake_user'].get('username')
    password = config['fake_user'].get('password')
    
    if not email or not password:
        raise ValueError("Must suply linkedin username and password")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("File not found. You must run get_connections.py firstly to generate this file")
